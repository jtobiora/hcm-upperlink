...
@NoArgsConstructor
@Entity
@Table(name = "recruitment_record")
public class RecruitmentRecord extends SuperModel implements Serializable {
    ...
    @JoinTable(name = "recruitment_request_authorizations",
            joinColumns = @JoinColumn(name = "recruitment_record_id"),
    ...
    @JsonManagedReference
    @ManyToMany(fetch = FetchType.EAGER, cascade = {CascadeType.PERSIST})
    @JoinTable(name = "recruitment_request_awareness",
            joinColumns = @JoinColumn(name = "recruitment_record_id"),
    ...
    public RecruitmentRecord(int numberOfOpening, String jobDescription, int minYearsExperience, GradeLevel minGradeLevel, GradeLevel maxGradeLevel,
                             JobRole jobRole, Employee supervisor, ApprovalStatus approvalStatus, Date approvalDate, String reason) {
    ...
    public boolean equals(Object o) {
        ...
        RecruitmentRecord that = (RecruitmentRecord) o;
    ...
    public String toString() {
        final StringBuilder sb = new StringBuilder("RecruitmentRecord{");
