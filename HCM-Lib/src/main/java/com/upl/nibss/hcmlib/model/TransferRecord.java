...
@Data
@Entity
public class TransferRecord extends SuperModel implements Serializable{
...
//    @JoinTable(name = "transfer_record_allowances",
...
//    private Set<Allowance> allowances;
    ...
    @JoinTable(name = "transfer_request_authorizations",
        joinColumns = @JoinColumn(name = "transfer_record_id"),
    ...
    @JsonManagedReference
    @ManyToMany(fetch = FetchType.EAGER, cascade = {CascadeType.PERSIST})
    @JoinTable(name = "transfer_request_awareness",
            joinColumns = @JoinColumn(name = "transfer_record_id"),
