...
@Data
@Entity
@Table(name = "training_record_history")
public class TrainingRecordHistory extends SuperModel implements Serializable {
...
//    private TrainingJustification trainingJustification;
    ...
    @JoinTable(name = "training_history_request_authorizations",
    ...
    @JsonManagedReference
    @ManyToMany(fetch = FetchType.EAGER, cascade = {CascadeType.PERSIST})
    @JoinTable(name = "training_history_request_awareness",
            joinColumns = @JoinColumn(name = "training_record_id"),
    ...
    public boolean equals(Object o) {
        ...
        TrainingRecordHistory that = (TrainingRecordHistory) o;
